...
class DatabaseRoutes {
    ...
    initialize() {
        ...
        this.router.get('/backup', this.controller.Backup.bind(this.controller))
        this.router.post('/restore-backup', this.controller.RestoreBackup.bind(this.controller))
        this.router.post('/decrypt-backup', this.controller.DecryptBackup.bind(this.controller))
